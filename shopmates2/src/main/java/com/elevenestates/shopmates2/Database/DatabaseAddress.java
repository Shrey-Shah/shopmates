...
public class DatabaseAddress {
	...
	private static final String DATABASE_NAME = "DatabaseAddress";
	private static final String DATABASE_TABLE_NAME = "DatabaseAddressTable";
	...
	public void getData(ArrayList<AddressDetails> addressList)
	{
		...
		if(c!=null && c.moveToFirst())
		{
			...
			{
				addressList.add(new AddressDetails(c.getString(iTag),c.getString(iDetails),c.getString(iPincode),c.getString(iLat),c.getString(iLng)));
			}
		}
	...
	public void editSno(int sno, AddressDetails ad) {
		...
		cv.put(KEY_LAT,ad.getLat());
		cv.put(KEY_LNG,ad.getLng());
